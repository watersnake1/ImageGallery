...
public class ViewController implements Globals {
    ...
    /**
     * setter method for the user to define the size of the window
     * @param size
     */
    public void setFramePreferredSize(Dimension size)
    {
        frame.setPreferredSize(size);
    }

    /**
     * setter method for the user to define if the window can be resized
     * @param b
     */
    public void setFrameIsResizable(boolean b)
    {
